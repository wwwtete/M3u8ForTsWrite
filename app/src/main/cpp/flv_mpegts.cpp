...
static int flv_mpegts_write_file(flv_mpegts_file_t *file, u_char *in, size_t in_size)
{
    ssize_t   rc;
...
{
    return flv_mpegts_write_file(file, flv_mpegts_header, sizeof(flv_mpegts_header));
}
